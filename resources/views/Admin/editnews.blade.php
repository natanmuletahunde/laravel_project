    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
               <h4>Edit News
               <a href="{{ url('admin/news')}}" class="btn btn-primary float-end" style="background-color: red; color: white;">BACK</a>
                </h4>
            </div>
            <div class="card-body">
                <form action="{{ url('admin/updatenews/'.$newsd->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
